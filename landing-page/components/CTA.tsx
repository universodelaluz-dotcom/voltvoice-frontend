      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative z-10 glass-effect-strong p-12 rounded-2xl border-2 border-voltvoice-cyan/30 text-center">
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
            Únete a miles de streamers que ya están monetizando con voces clonadas. Sin experiencia técnica requerida. Comienza en segundos.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 text-left">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-300">Configuración en 30 segundos</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1 h-1 bg-voltvoice-cyan rounded-full" />
              <span className="text-gray-300">No se requiere tarjeta de crédito</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1 h-1 bg-voltvoice-cyan rounded-full" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="group px-8 py-4 bg-gradient-to-r from-voltvoice-cyan to-voltvoice-purple rounded-lg font-bold text-white text-lg hover:shadow-glow-cyan-lg transition-all duration-300 transform hover:scale-105 btn-glow flex items-center justify-center gap-2">
