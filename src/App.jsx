...
const DEFAULT_CONFIG = {
  ...
  onlyQuestions: false,
  tt_onlyDonors: false,
  tt_onlyModerators: false,
  tt_onlySubscribers: false,
  tt_onlyCommunityMembers: false,
  tt_onlyQuestions: false,
  yt_onlyDonors: false,
  yt_onlyModerators: false,
  yt_onlySubscribers: false,
  yt_onlyCommunityMembers: false,
  yt_onlyQuestions: false,
  yt_onlySuperChatMessages: false,
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <div className="flex items-center gap-2 mt-4">
                <svg viewBox="0 0 90 20" width="80" height="18" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="YouTube">
                  ...
                  <path d="M34.6024 13.0036L31.3945 1.41846H33.7623L35.1171 6.90385C35.4671 8.33215 35.7171 9.55261 35.8696 10.5815H35.9346C36.0421 9.8252 36.2946 8.61472 36.6947 6.90385L38.0996 1.41846H40.4675L37.2596 13.0036V18.6264H34.6024V13.0036Z" fill={darkMode ? 'white' : '#111'}/>
                  <path d="M41.4481 17.6626C40.7231 17.0901 40.2331 16.1826 40.0006 14.9946C39.8331 14.1196 39.7506 12.9971 39.7506 11.6271V10.3121C39.7506 8.91456 39.8456 7.77457 40.0356 6.89957C40.2906 5.69208 40.8081 4.77959 41.5906 4.16209C42.3731 3.5446 43.4431 3.2346 44.8006 3.2346C46.1206 3.2346 47.1681 3.5446 47.9431 4.16209C48.7181 4.77959 49.2206 5.68958 49.4506 6.89957C49.6406 7.77457 49.7356 8.91456 49.7356 10.3121V11.6271C49.7356 12.9971 49.6456 14.1196 49.4506 14.9946C49.2181 16.1826 48.7156 17.0901 48.0006 17.6626C47.2806 18.2351 46.2206 18.5226 44.8231 18.5226C43.3831 18.5226 42.2956 18.2351 41.4481 17.6626ZM46.0531 15.9351C46.2881 15.4351 46.4056 14.6226 46.4056 13.4971V8.42458C46.4056 7.32959 46.2881 6.52209 46.0531 6.02209C45.8181 5.5221 45.3956 5.2746 44.8006 5.2746C44.2231 5.2746 43.8081 5.5221 43.5731 6.02209C43.3381 6.52209 43.2206 7.32959 43.2206 8.42458V13.4971C43.2206 14.6226 43.3331 15.4351 43.5606 15.9351C43.7881 16.4351 44.2056 16.6826 44.8006 16.6826C45.3956 16.6826 45.8181 16.4351 46.0531 15.9351Z" fill={darkMode ? 'white' : '#111'}/>
                  <path d="M56.8154 18.6262H54.6654L54.4154 17.0912H54.3504C53.7004 18.0437 52.8129 18.5212 51.6879 18.5212C50.8754 18.5212 50.2654 18.2562 49.8654 17.7262C49.4654 17.1962 49.2654 16.3912 49.2654 15.3112V3.4946H51.9154V15.0962C51.9154 15.6237 51.9779 16.0012 52.1054 16.2262C52.2329 16.4512 52.4454 16.5637 52.7429 16.5637C52.9954 16.5637 53.2379 16.4887 53.4754 16.3337C53.7104 16.1787 53.8829 15.9812 53.9904 15.7387V3.4946H56.8154V18.6262Z" fill={darkMode ? 'white' : '#111'}/>
                  <path d="M64.4755 3.23598C63.7755 3.23598 63.1505 3.42348 62.5905 3.79848C62.033 4.17348 61.6105 4.69348 61.333 5.35848H61.298V0.785645H58.648V18.6281H60.8355L61.1205 17.2681H61.1855C61.433 17.7456 61.838 18.1231 62.3955 18.4006C62.953 18.6781 63.568 18.8156 64.248 18.8156C65.418 18.8156 66.2905 18.3081 66.8705 17.2906C67.448 16.2756 67.7355 14.6931 67.7355 12.5506V9.85313C67.733 6.44063 66.648 3.23598 64.4755 3.23598ZM65.0855 12.3931C65.0855 13.5906 65.0105 14.5256 64.858 15.2006C64.7055 15.8731 64.4705 16.3581 64.153 16.6531C63.8355 16.9481 63.4355 17.0956 62.953 17.0956C62.6005 17.0956 62.2755 17.0106 61.978 16.8431C61.678 16.6731 61.443 16.4306 61.268 16.1106V7.02313C61.4055 6.54813 61.648 6.15813 61.998 5.85813C62.348 5.55813 62.7255 5.40813 63.1255 5.40813C63.5955 5.40813 63.9655 5.56063 64.2355 5.86563C64.508 6.17063 64.703 6.66813 64.823 7.35813C64.9405 8.04813 65.0005 9.00813 65.0005 10.2406V12.3931H65.0855Z" fill={darkMode ? 'white' : '#111'}/>
                  <path d="M73.8129 3.23598C72.2379 3.23598 71.0304 3.69348 70.1904 4.60848C69.3504 5.52348 68.9304 6.87098 68.9304 8.65098V13.2035C68.9304 15.0085 69.3604 16.366 70.2204 17.276C71.0804 18.186 72.3304 18.641 73.9754 18.641C75.0979 18.641 76.0379 18.4185 76.7979 17.9735C77.5579 17.526 78.1054 16.8635 78.4379 15.9785C78.7704 15.096 78.9354 13.9685 78.9354 12.601V12.1235H76.3354V12.7235C76.3354 13.761 76.2554 14.5435 76.0979 15.071C75.9404 15.5985 75.7004 15.966 75.3754 16.1685C75.0504 16.371 74.6629 16.4735 74.2104 16.4735C73.6629 16.4735 73.2354 16.341 72.9254 16.0785C72.6154 15.816 72.3979 15.3985 72.2729 14.836C72.1479 14.271 72.0829 13.476 72.0829 12.451V10.7585H79.0004V8.65098C79.0004 6.87098 78.5979 5.52348 77.7979 4.60848C76.9954 3.69348 75.8029 3.23598 73.8129 3.23598ZM76.3654 8.90848H72.0829V8.30348C72.0829 7.30348 72.1654 6.54848 72.3254 6.03848C72.4879 5.52848 72.7179 5.17098 73.0179 4.96598C73.3154 4.76098 73.6954 4.65848 74.1479 4.65848C74.6079 4.65848 74.9929 4.77348 75.3029 4.99848C75.6129 5.22348 75.8354 5.59348 75.9704 6.10848C76.1054 6.62348 76.1704 7.35348 76.1704 8.30348V8.90848H76.3654Z" fill={darkMode ? 'white' : '#111'}/>
                </svg>
              </div>
              <p className="text-xs text-gray-500 mt-1">{isEnglish ? 'Compatible with YouTube Live' : 'Compatible con YouTube Live'}</p>
            </div>
            <div>
              <h4 className="font-bold mb-4">Legal</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="/terms/" className="hover:text-cyan-400 transition">{t('landing.footer.terms')}</a></li>
                <li><a href="/privacy/" className="hover:text-cyan-400 transition">{t('landing.footer.privacy')}</a></li>
