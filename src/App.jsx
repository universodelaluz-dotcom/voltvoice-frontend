            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-4">
                <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.582 2.186A2.506 2.506 0 0 0 17.82.418C16.254 0 10 0 10 0S3.746 0 2.18.418A2.506 2.506 0 0 0 .418 2.186C0 3.754 0 7 0 7s0 3.246.418 4.814A2.506 2.506 0 0 0 2.18 13.582C3.746 14 10 14 10 14s6.254 0 7.82-.418a2.506 2.506 0 0 0 1.762-1.768C20 10.246 20 7 20 7s0-3.246-.418-4.814Z" fill="#FF0000"/>
                  <path d="M8 10l5.196-3L8 4v6Z" fill="white"/>
                </svg>
                <span className="font-semibold text-sm" style={{color: darkMode ? 'white' : '#111'}}>YouTube</span>
              </div>
