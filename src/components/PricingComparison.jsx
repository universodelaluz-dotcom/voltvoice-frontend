...
const comparisonData = {
  features: [
    ...
    {
      category: 'Herramientas y Caracteristicas',
      items: [
        { name: 'Herramientas optimizadoras de mensajes', free: false, start: true, creator: true, pro: true },
        { name: 'Voces dinamicas por tipo de usuario', free: false, start: 'limitado', creator: true, pro: true },
        { name: 'Filtros basicos para optimizar el chat', free: 'limitado', start: true, creator: true, pro: true },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Duracion aprox. de voces especiales*', free: null, start: '2-4 horas', creator: '5-8 horas', pro: '10-15 horas' }
      ]
    }
  ],
  plans: [
    { id: 'free', name: 'FREE', price: '$0', color: 'from-gray-400 to-gray-600', bgColor: 'bg-gray-50', borderColor: 'border-gray-300', textColor: 'text-gray-900', icon: 'FREE' },
    { id: 'start', name: 'START', price: '$6.99', color: 'from-green-400 to-emerald-600', bgColor: 'bg-gradient-to-br from-green-50 to-emerald-50', borderColor: 'border-green-300', textColor: 'text-gray-900', icon: 'START' },
    { id: 'creator', name: 'CREATOR', price: '$12.99', color: 'from-blue-400 to-indigo-600', bgColor: 'bg-gradient-to-br from-blue-50 to-indigo-50', borderColor: 'border-blue-300', textColor: 'text-gray-900', icon: 'CREATOR', popular: true },
    { id: 'pro', name: 'PRO', price: '$17.99', color: 'from-orange-400 to-red-600', bgColor: 'bg-gradient-to-br from-orange-50 to-red-50', borderColor: 'border-orange-300', textColor: 'text-gray-900', icon: 'PRO' }
  ]
}
      ...
      <div className="max-w-7xl mx-auto">
                ...
                {comparisonData.plans.map((plan) => (
                  <th key={plan.id} className="py-6 px-4">
                    <div className={`rounded-2xl p-6 text-center shadow-lg transition-all hover:shadow-xl border-2 ${
                      ...
                      <div className="text-base font-bold mb-3">{plan.icon}</div>
          ...
          {comparisonData.plans.map((plan) => (
            <div key={plan.id} className={`rounded-xl border-2 ${plan.borderColor} overflow-hidden shadow-lg`}>
              <div className={`${plan.bgColor} p-6 text-center`}>
                <div className="text-base font-bold mb-2">{plan.icon}</div>
        ...
        <div className={`mt-16 p-6 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-blue-50'}`}>
          ...
          <ul className={`text-sm space-y-2 ${darkMode ? 'text-gray-100' : 'text-gray-700'}`}>
            ...
            <li>- <strong>Voces clonadas/premium:</strong> Los tokens mensuales definen cuanto tiempo puedes usar tus voces especiales.</li>
            <li>- <strong>Renovacion mensual:</strong> Los tokens se resetean cada mes automaticamente.</li>
